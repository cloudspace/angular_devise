      ...
      function ($q, $http, $rootScope) {
        ...
        var service = {
            ...
            login: function (creds) {
              ...
              return $http(httpConfig('login', resourceObj)).then(service.parse).then(save).then(function (user) {
            ...
            register: function (creds) {
              ...
              var resourceObj = {};
              resourceObj[_resourceName] = creds;
              return $http(httpConfig('register', resourceObj)).then(service.parse).then(save).then(broadcast('new-registration'));
            },
