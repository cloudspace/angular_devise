      ...
      function ($q, $http, $rootScope) {
        ...
        var service = {
            ...
            send_reset_password_instruction: function (creds) {
              creds = creds || {};
              return $http(httpConfig('send_reset_password_instruction', { user: creds })).then(service.parse).then(save).then(broadcast('send-reset-password-instruction-successfully'));
            },
